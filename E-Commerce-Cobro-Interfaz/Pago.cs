...
namespace E_Commerce_Cobro_Interfaz
{
    internal class Pago
    {
        ...
        public Tarjetaclass Tarjetas { get => tarjetas; set => tarjetas = value; }
        ...
        public Pago(decimal monto, DateTime fecha, Tarjetaclass tarjetas)
        {
            this.monto = monto;
            this.fecha = fecha;
