...
namespace E_Commerce_Cobro_Interfaz
{
    internal class Tarjetaclass
    {
        ...
        public Tarjetaclass(Usuario usuarios)
        {
            this.usuarios = usuarios;
        }

        internal Tarjetaclass(string numero, string titular, int dniTitular, string banco, DateTime vencimiento, int codSeguridad, TipoTarjeta tipo, Usuario usuario)
        {
            Numero = numero;
            Titular = titular;
